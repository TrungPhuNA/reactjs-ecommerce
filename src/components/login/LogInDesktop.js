                                ...
                                <>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="left-content-heading-input">
                                            ...
                                            <input type="name" value={name} placeholder="Nhập họ và tên" onChange={(e) => setName(e.target.value)} maxlength="50" />
                                            <label className="text-title">Email</label>
                                            <input type="email" placeholder="Nhập email" onChange={(e) => setEmail(e.target.value)} maxlength="50" />
                                            ...
                                            <input type="phone" placeholder="Nhập số điện thoại" onChange={(e) => setPhone(e.target.value)} maxlength="10" />
                                            ...
                                            <input type="address" placeholder="Nhập địa chỉ" onChange={(e) => setAddress(e.target.value)} maxlength="10" /> 
                                        </div>
                                        <Link to="/"><button type="submit">Tiếp tục</button></Link>
                                    </form>
