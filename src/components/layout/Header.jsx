                ...
                <div className="cm-width main-header--bottom--title">
                    <div className="left">
                        ...
                        <div className="left__link">
                            <a className="item-link">Trái cây</a>
                            <a className="item-link">Thịt, trứng</a>
                            <a className="item-link">rau củ quả</a>
                            <a className="item-link">sữa, bơ, phô mai</a>
                            <a className="item-link">hải sản</a>
                            <a className="item-link">gạo, mỳ ăn liền</a>
                            <a className="item-link">đồ uống, bia rượu</a>
                            <a className="item-link">bánh kẹo</a>
                        </div>
                    </div>
