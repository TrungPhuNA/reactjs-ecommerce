...
function MenuMobile() {
    ...
    return (
        <div className="menu__mobile">
            <a className={menu === 1?'active':''} onClick={() => changeMenu(1)}>
            ...
            <a href='javascript:void(0)' title='Home' className={menu === 2?'active':''} onClick={() => changeMenu(2)}>
            ...
            <a href='javascript:void(0)' title='Home' className={menu === 3?'active':''} onClick={() => changeMenu(3)}>
            <FireOutlined style={{color:menu === 3?'color: rgb(13, 92, 182)':'#8C8C8C'}}/>
                <span className='fs-10'>Lướt</span>
            </a>
            <a href='javascript:void(0)' title='Home' className={menu === 4?'active':''} onClick={() => changeMenu(4)}>
            <CommentOutlined style={{color:menu === 4?'color: rgb(13, 92, 182)':'#8C8C8C'}}/>
                <span className='fs-10'>Chat</span>
            </a>
            <a href='javascript:void(0)' title='Home' className={menu === 5?'active':''} onClick={() => changeMenu(5)}>
