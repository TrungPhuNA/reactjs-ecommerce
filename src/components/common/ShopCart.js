                        ...
                        <div className="left-content-container">
                            <div className="seller-group">
                                <div className="seller-subtitle">
                                    ...
                                    <img src="https://salt.tikicdn.com/ts/upload/30/24/79/8317b36e87e7c0920e33de0ab5c21b62.png" alt="seller-link" className="sellers__icon-home"></img>
                                    <Link to="/cart" className="seller-name">
                                        Tiki Trading
                                        <img src="https://frontend.tikicdn.com/_desktop-next/static/img/icons/Path.svg" alt="seller-link" className="sellers__icon-arrow"></img>
                                    </Link>
                                </div>
                            </div>
