                                ...
                                <div className={`product-item--style ${ item.pro_sale === 0 ? 'not-style':''}`}>
                                    <div className="thumbnail">
                                        <div className="thumbnail--icon-badge">
                                            <Images src={item.pro_avatar || '/images/product-detault.png'} alt="333"/>
                                        </div>
                                        <div className="thumbnail--product-img">
                                            <Images src={item.pro_avatar || '/images/product-detault.png'} alt="111" />
                                        </div>
                                    </div>
                                    <div className="infor">
                                        <>
                                            ...
                                            <div className={`price-discount has-discount`}>
                                                <div className="price-discount__price">
                                                    { item.pro_sale > 0  ? currencyFormat(priceDiscount(item.pro_price, item.pro_sale)) : currencyFormat(item.pro_price) }
                                                </div>
                                                { item.pro_sale > 0 && (
